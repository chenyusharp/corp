...
public class APITest {
    ...
    //商品列表查询接口
//    public static String PRODUCTS_SEARCH_URL = "/gs_full_service_commodity/202406/beta/products/search";
...
//        String request_url = COMMON_PATH_PREFIX + BRAND_SEARCH;
        ...
        //获取accessToken
        Headers headers = Headers.of("x-tts-access-token", "ROW_Pdso9wAAAAD8YDnyiVK7IfEIkutWul5cPdu1dQ0l1E8OzbjslJ-L1nXk0RpyEOEH0XjZpuEoDLQScSCnnCHrtgn6yk9BsypHO4sBUBKHUapIjWotAv4SzQ",
                "UserAgent", "EP");
...
//        String request_url = COMMON_PATH_PREFIX + BRAND_SEARCH;
        ...
        String plm_demo_test_url = "http://127.0.0.1:9081/plm/demo/testOkhttps";
