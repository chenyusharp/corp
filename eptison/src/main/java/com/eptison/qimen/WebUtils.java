...
import com.eptison.exception.EpUnexpectedException;
...
public class WebUtils {
	...
	public static String doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout) throws IOException {
		return internDoPost(url, ctype, content, connectTimeout, readTimeout, null);
	}

	private static String internDoPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout, Map<String, String> headerMap) throws IOException {
	...
	public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset,
		...
		if (fileParams == null || fileParams.isEmpty()) {
			...
			return internDoPostWithFile(url, params, fileParams, charset, connectTimeout, readTimeout, headerMap);
		}
	}

	private static String internDoPostWithFile(String url, Map<String, String> params, Map<String, FileItem> fileParams,
	...
	public static String decode(String value, String charset) {
		...
		if (!StringUtils.isEmpty(value)) {
			try {
				...
				throw new EpUnexpectedException(e);
			}
		}
		return result;
	}
